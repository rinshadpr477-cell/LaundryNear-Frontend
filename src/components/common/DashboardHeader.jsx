...

                {
                    ...
                    <div className="flex items-center">
                        ...
                        <input
                            ...
                            className="w-[450px] px-5 py-3 rounded-2xl border border-[#E3D7C8] bg-white outline-none focus:border-[#7B614D]"
                        />
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            <img
                                src={profileImage}
                                alt=""
                                className="w-11 h-11 rounded-full object-cover border border-[#CBB89B]"
                            />
...

                        {
                            ...
                            <div className="absolute right-0 top-14 w-56 bg-white rounded-3xl border border-[#E3D7C8] shadow-xl overflow-hidden">
                                ...
                                <button
                                    ...
                                    className="w-full text-left px-5 py-3 hover:bg-[#F5F1EB]"
                                >
                                    Profile
                                </button>
                                ...
                                <button
                                    ...
                                    className="w-full text-left px-5 py-3 text-red-500 hover:bg-[#F5F1EB]"
                                >
                                    Logout
                                </button>
