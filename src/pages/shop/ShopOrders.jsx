...

                          {
                            item.status === "Pending" ? (
                              <button
                                ...
                                className="bg-[#1A1A1A] text-white px-5 py-3 rounded-2xl text-sm font-semibold hover:bg-[#3F2F24] duration-300"
                              >
                                Accept Order
                              </button>
                            ) : (
                              <select
                                ...
                                className="border border-[#D8C7B8] bg-white px-4 py-3 rounded-2xl text-sm font-semibold outline-none"
                              >
